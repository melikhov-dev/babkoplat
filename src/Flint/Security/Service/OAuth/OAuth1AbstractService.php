...
use OAuth\OAuth1\Service\AbstractService as parentOauth1AbsctactService;

abstract class OAuth1AbstractService extends parentOauth1AbsctactService implements OAuthUserResultInterface{
