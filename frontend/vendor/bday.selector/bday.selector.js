...
(function( $ ){
    ...
    var months = {
            ...
            "long": ["Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сенрябрь", "Октябрь", "Ноябрь", "Декабрь"] },
        todayDate = new Date(),
    ...
    $.fn.birthdaypicker = function( options ) {
        ...
        return this.each(function() {
            ...
            if (settings["placeholder"]) {
                $("<option value='0'>Год:</option>").appendTo($year);
                $("<option value='0'>Месяц:</option>").appendTo($month);
