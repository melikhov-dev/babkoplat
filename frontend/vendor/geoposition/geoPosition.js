...
var geoPosition = function () {
    ...
    pub.init = function () {
        try {
            ...
            //в мобильной версии хрома сейчас баг, геолокация отваливается по таймауту
            var mobileChrome = navigator.userAgent.match(/Android/) && navigator.userAgent.match(/Mobile/) && true;
            ...
            } else if (!mobileChrome && hasGeolocation) {
            ...
            } else if (typeof (ymaps) != u && ymaps.geolocation != u) {
                pub.getCurrentPosition = function (success, error, opts) {
                    success({
                        coords: {
